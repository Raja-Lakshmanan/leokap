...
const Footer = () => {
  return (
    <footer className="bg-black py-20 px-8 md:px-16 border-t border-[rgba(255,255,255,0.05)]">
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
        ...
        {/* Products Links */}
        <div>
          <h4 className="text-sm font-bold tracking-widest uppercase text-[var(--gold)] mb-6">Products</h4>
          <ul className="space-y-4 text-[var(--text-secondary)] font-light">
            {['Tile Adhesive', 'Tile Grout', 'Waterproofing', 'Wall Putty', 'Screed'].map(product => (
              <li key={product}>
                <a 
                  href="#products" 
                  onClick={(e) => {
