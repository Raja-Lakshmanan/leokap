  ...
  return (
    <div className="fixed right-6 bottom-12 z-[100] flex flex-col space-y-4">
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        className="w-14 h-14 rounded-full bg-[rgba(10,10,12,0.8)] flex items-center justify-center border border-[rgba(255,255,255,0.1)] backdrop-blur-md relative group overflow-hidden"
      >
        <span className="absolute inset-0 w-full h-full bg-[var(--blue)]/20 scale-0 group-hover:scale-100 transition-transform duration-300 rounded-full origin-center"></span>
        <svg className="w-6 h-6 text-white relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
